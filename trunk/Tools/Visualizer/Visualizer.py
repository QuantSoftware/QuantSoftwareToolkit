...
#		self.mpl_toolbar = NavigationToolbar(self.canvas, self.main_frame)
		...
		self.VisLable = QtGui.QLabel('qstkViz', self)
...
#		Vbox1.addLayout(shbox)
#		Vbox1.addLayout(chbox)
...
#		Finalvbox.addWidget(self.mpl_toolbar)
	...
	def PlotCanvas(self):
		...
		xs1 = [self.inrange(x, self.XLow, self.XHigh) for x in xs]
		ys1 = [self.inrange(y, self.YLow, self.YHigh) for y in ys]
		zs1 = [self.inrange(z, self.ZLow, self.ZHigh) for z in zs]
