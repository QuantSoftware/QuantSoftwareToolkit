...
report.print_stats(df_aapl, ["$SPX","MSFT"], "AAPL", original=df_goog, s_original_name="GOOG", d_trading_params={"Number of trades":200,"Trading Period":"Weekly"},d_hedge_params=ls_hedge_params, s_comments="This is a sample report generated by tutorial 5.", commissions=f_commision, slippage=f_slippage, directory="./AAPL/")
